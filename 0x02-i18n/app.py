...
def index():
    ...
    local_time = now_utc.astimezone(pytz.timezone(user_timezone))
    # Convert to user's local time

    # Format the local time using Babel
    formatted_time = format_datetime(local_time)
    return render_template(
        'index.html', timezone=user_timezone, current_time=formatted_time
    )
